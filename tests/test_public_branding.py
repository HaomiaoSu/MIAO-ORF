...
class PublicBrandingTest(unittest.TestCase):
    def test_public_release_identity(self) -> None:
        ...
        self.assertIn("Central South University, Hunan, China", citation)
        license_text = (ROOT / "LICENSE").read_text(encoding="utf-8")
        self.assertTrue(license_text.startswith("MIT License"))
        self.assertIn("Copyright (c) 2026 Haomiao Su\n", license_text)
        self.assertNotIn("MIAO contributors", license_text)
        psite_text = (ROOT / "src/miao_orf/psite-caller.py").read_text(encoding="utf-8")
        self.assertIn("suhaomiao@csu.edu.cn", psite_text)
        self.assertNotIn("suhaomiao@gmail.com", psite_text)
